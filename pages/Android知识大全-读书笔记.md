...
- "折半查找" ([Link](zotero://open-pdf/library/items/KV6IDU35?page=539) )
...
- "6.举一个用 Java 实现的装饰模式(decorator design pattern)？它是作用于对象层次还是类 层次？" ([Link](zotero://open-pdf/library/items/KV6IDU35?page=580) )
...
- "4. Oracle JDK 和 OpenJDK 的对比" ([Link](zotero://open-pdf/library/items/KV6IDU35?page=600) )
...
- "8) Java 中的 volatile 关键是什么作用？怎样使用它？在 Java 中它跟 synchronized 方法有什 么不同？" ([Link](zotero://open-pdf/library/items/KV6IDU35?page=629) )
...
- "17.谈谈你对安卓签名的理解。" ([Link](zotero://open-pdf/library/items/KV6IDU35?page=663) )
...
- "1、四大组件是什么" ([Link](zotero://open-pdf/library/items/KV6IDU35?page=678) )
...
- "16、AIDL理解" ([Link](zotero://open-pdf/library/items/KV6IDU35?page=701) )
...
- "7.2、抽象类与接口的应用场景" ([Link](zotero://open-pdf/library/items/KV6IDU35?page=737) )
...
- "19. jvm，jre 以及 jdk 三者之间的关系？JDK（Java Development Kit）是针对 Java 开发员的产品，是整个 Java 的核心，包括了 Java 运行环境 JRE、Java 工具和 Java 基础类库。" ([Link](zotero://open-pdf/library/items/KV6IDU35?page=764) )
...
- "27. 27. Android Glide 源码解析" ([Link](zotero://open-pdf/library/items/KV6IDU35?page=786) )
...
- "4、如何解决 View的事件冲突 ？ 举个开发中遇到的例子 ？" ([Link](zotero://open-pdf/library/items/KV6IDU35?page=841) )
...
- "2、Service的两种启动方式？区别在哪？" ([Link](zotero://open-pdf/library/items/KV6IDU35?page=872) )
- "3、如何保证 Service不被杀死 ？" ([Link](zotero://open-pdf/library/items/KV6IDU35?page=873) )
- "4、能否在 Service开启耗时操作 ？ 怎么做 ？" ([Link](zotero://open-pdf/library/items/KV6IDU35?page=874) )
- "5、用过哪些系统 Service ？" ([Link](zotero://open-pdf/library/items/KV6IDU35?page=874) )
- "6、了解 ActivityManagerService吗？发挥什么作用" ([Link](zotero://open-pdf/library/items/KV6IDU35?page=875) )
- "1、广播有几种形式 ? 都有什么特点 ？" ([Link](zotero://open-pdf/library/items/KV6IDU35?page=875) )
- "2、广播的两种注册方式 ？" ([Link](zotero://open-pdf/library/items/KV6IDU35?page=875) )
- "3、广播发送和接收的原理了解吗 ？（Binder机制、AMS）" ([Link](zotero://open-pdf/library/items/KV6IDU35?page=875) )
- "1、谈谈消息机制 Handler作用 ？有哪些要素 ？流程是怎样的 ？" ([Link](zotero://open-pdf/library/items/KV6IDU35?page=877) )
- "2、一个线程能否创建多个 Handler，Handler跟 Looper之间的对应关 系 ？" ([Link](zotero://open-pdf/library/items/KV6IDU35?page=879) )
- "3、软引用跟弱引用的区别" ([Link](zotero://open-pdf/library/items/KV6IDU35?page=879) )
- "4、Handler 引起的内存泄露原因以及最佳解决方案" ([Link](zotero://open-pdf/library/items/KV6IDU35?page=880) )
- "5、为什么系统不建议在子线程访问 UI？" ([Link](zotero://open-pdf/library/items/KV6IDU35?page=881) )
- "6、Looper死循环为什么不会导致应用卡死？" ([Link](zotero://open-pdf/library/items/KV6IDU35?page=882) )
- "7、使用 Handler的 postDealy后消息队列会有什么变化？" ([Link](zotero://open-pdf/library/items/KV6IDU35?page=882) )
- "8、可以在子线程直接 new一个 Handler吗？怎么做？" ([Link](zotero://open-pdf/library/items/KV6IDU35?page=882) )
- "9、Message可以如何创建？哪种效果更好，为什么？" ([Link](zotero://open-pdf/library/items/KV6IDU35?page=883) )
- "1、线程池的好处？ 四种线程池的使用场景，线程池的几个参数的理解？" ([Link](zotero://open-pdf/library/items/KV6IDU35?page=885) )
- "2、Android中还了解哪些方便线程切换的类？" ([Link](zotero://open-pdf/library/items/KV6IDU35?page=887) )
- "3、讲讲 AsyncTask的原理" ([Link](zotero://open-pdf/library/items/KV6IDU35?page=887) )
- "4、IntentService有什么用 ？" ([Link](zotero://open-pdf/library/items/KV6IDU35?page=888) )
- "5、直接在 Activity中创建一个 thread跟在 service中创建一个 thread之间 的区别？" ([Link](zotero://open-pdf/library/items/KV6IDU35?page=888) )
- this is a android note